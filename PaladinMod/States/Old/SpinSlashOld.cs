...
{
    public class SpinSlashOld : BaseSkillState
    {
        ...
        {
            this.dashSpeed = (2 + (0.5f * this.moveSpeedStat)) * Mathf.Lerp(SpinSlashOld.initialSpeedCoefficient, SpinSlashOld.finalSpeedCoefficient, base.fixedAge / this.duration);
        }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.isAuthority)
            {
                if (!this.inHitPause)
                {
                    ...
                    this.attack.damage = this.damageStat * SpinSlashOld.chargeDamageCoefficient;
