...
Weaver\Unity.UNetWeaver.exe libs\weave\UnityEngine.CoreModule.dll libs\weave\com.unity.multiplayer-hlapi.Runtime.dll %TargetDir%\ Weaver\%TargetFileName% libs\weave
